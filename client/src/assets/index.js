...
export const battlegrounds = [
  { id: 'bg-saiman', image: saiman.src, name: 'Saiman' },
  { id: 'bg-astral', image: astral.src, name: 'Astral' },
  { id: 'bg-eoaalien', image: eoaalien.src, name: 'Eoaalien' },
  { id: 'bg-panight', image: panight.src, name: 'Panight' },
];
